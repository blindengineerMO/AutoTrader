// Kept dependency-free and duplicated (not required) from src/shared/crawlGuard.js
// in the main repo, since this package must run standalone on a third-party
// operator's machine with no access to the coordinator's codebase.
